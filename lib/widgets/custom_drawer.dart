              ...
              children: [
                Padding(
                  ...
                  child: Column(
                    ...
                    mainAxisSize: MainAxisSize.min, // içeriğe göre yükseklik al
                    children: [
                      CircleAvatar(
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(width: 6,),
                          // premium logo
                          SizedBox(height: 16, width: 16, child: Image.asset("assets/icons/premium_logo.png"),)
                        ],
                      ),
                      SizedBox(height: 5),
                      MyText(
                      ...
                      Row(
                        children: [
                          SizedBox(
                            height: 30,
                            width: 30,
                            child: Image.asset("assets/icons/hyundai_logo.png"),
                          ),
                          SizedBox(width: 6),
                          Expanded(
                            child: MyText(
                              textContent: "Hyundai Otomotiv",
                              textSize: Constants.fontSizeMiniTitle,
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 10),
                      MyText(textContent: "Ayarlar", textSize: 16, textWeight: FontWeight.w900, textColor: Constants.mainBlackColor)
                    ],
                  ),
                ),
              ),
