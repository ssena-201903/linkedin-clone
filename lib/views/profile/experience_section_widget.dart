    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              MyText(textContent: title, textSize: Constants.textHeaderSize, textWeight: Constants.textHeaderWeight, textColor: Constants.textHeaderColor),
              Spacer(),
              // plus and edit icon
              Row(
                ...
                children: [
                  ...
                  // edit icon
                  SizedBox(height: 26, width: 26, child: Image.asset("assets/icons/pencil.png"),)
                ],
              )
            ],
          ),
