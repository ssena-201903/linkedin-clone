...
class PostDetailCard extends StatefulWidget {
  ...
  const PostDetailCard({super.key, required this.companyLogo, required this.companyName, required this.postImage, required this.followerCount, required this.minute, required this.commentCount, required this.shareCount});
                        ...
                        Expanded(
                          child: Stack(
                            children: [
                              ...
                              Positioned(
                                left: 60,
                                child: MyText(textContent: "5", textSize: 14, textWeight: FontWeight.w400, textColor: Colors.black54)
                              )
                            ],
                          ),
                        ),
