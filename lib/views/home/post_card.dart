                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image: AssetImage("assets/icons/queens_logo.png"),
                                ),
                              ),
                            ),
                            SizedBox(width: 10),
                    ...
                    children: [
                      Expanded(
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage("assets/images/post_image2.png"), fit: BoxFit.cover,
                            ),
                          ),
                        ),
                      ),
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Row(
                            ...
                            children: [
                              MyText(textContent: "19 yorum", textSize: 14, textWeight: FontWeight.w400, textColor: Colors.black54),
                              SizedBox(width: 6,),
                              MyText(textContent: "·", textSize: 16, textWeight: FontWeight.bold, textColor: Colors.black54),
                              SizedBox(width: 6,),
                              MyText(textContent: "45 paylaşım", textSize: 14, textWeight: FontWeight.w400, textColor: Colors.black54),
                            ],
                          )
                        )
                      ]
